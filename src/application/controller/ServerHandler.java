...
//                System.out.println(action);
  ...
  public void closeServerHandler() {
    try {
      ...
      System.out.println("" + socket.getInetAddress() + " " + socket.getPort()
              + " and " + socket2.getInetAddress() + " " + socket.getPort() + " game over!");
    } catch (IOException e) {
  ...
  public synchronized void getAccount() {
    try {
      String path = String.valueOf(getClass().getClassLoader()
                      .getResource("application/controller/account.csv").toURI());
      CsvReader infile = new CsvReader("application/controller/account.csv",
  ...
  public synchronized void writeBackAccount() {
    try {
      ...
      BufferedWriter w = new BufferedWriter(new OutputStreamWriter(
              new FileOutputStream("application/controller/account.csv"), "UTF-8"));
